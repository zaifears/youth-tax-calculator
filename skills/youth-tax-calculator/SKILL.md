...
## 2. Statutory Foundations & Current Rates (Per PwC Bangladesh Tax Summary)

### A. Tax-Free Exemption Ceilings (General & Special)
| Category | Tax-Free Threshold | Statutory Basis |
| :--- | :---: | :--- |
| **General Taxpayers (Male / Resident)** | **BDT 400,000** | Finance Act Standard |
| **Female Taxpayers & Senior Citizens (Aged 65+)** | **BDT 450,000** | Finance Act Standard |
| **Persons with Disabilities / Third Gender** | **BDT 525,000** | Finance Act Standard |
| **Gazetted War-Wounded Freedom Fighters** | **BDT 550,000** | Finance Act Standard |
...
| :--- | :---: | :---: |
| **First Tier (Up to Tax-Free Threshold)** | **0% (Nil)** | BDT 0 |
| **Next BDT 300,000** | **10%** | BDT 30,000 |
| **Next BDT 400,000** | **15%** | BDT 60,000 |
| **Next BDT 500,000** | **20%** | BDT 1,00,000 |
| **Next BDT 20,00,000** | **25%** | BDT 5,00,000 |
| **Remaining Balance** | **30%** | Top marginal slab |

### C. The Minimum Tax Floor Rules (Official Manual Page 67 & Section 163)
* **Standard Minimum Tax:** BDT 5,000 (New taxpayers: BDT 1,000 where applicable)
* ⚠️ **CRUCIAL RULE FOR YOUTH & STUDENTS:** Minimum tax **only applies if Total Taxable Income exceeds the tax-free exemption threshold**. If your taxable income is equal to or less than the threshold (e.g., student with taxable income $\le$ BDT 400,000), total tax payable is strictly **BDT 0.00**. Minimum tax is **NEVER** charged on income below the tax-free limit!
